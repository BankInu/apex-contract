...
██   ██ ██      ███████ ██   ██  ██████ ██   ██ ██   ██ ██   ████  ██████  ███████ 
    ...
    Decimal = 18
    2% of each transaction to the liquidity pool
    4% of each transaction to the marketing wallet in ether
    3% of each transaction to holders
*/
...
contract APEX is Context, IERC20, Ownable {
    ...
    string private _name     = "APEXCHANGE";
    string private _symbol   = "APEX";
    uint8 private  _decimals = 18;
    
    uint256 public _taxFee       = 3; 
    uint256 public _liquidityFee = 6; 
    uint256 public _percentageOfLiquidityForMarketing = 66; 
    
    uint256 public  _maxTxAmount     = 100000000000000 * 10**18 ;
    uint256 private _minTokenBalance = 10000000 * 10**18;
    ...
    constructor (address cOwner, address marketingWallet) Ownable(cOwner) {
        ...
        // uniswap
         ...
         IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Uniswap         
       //  IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Testnet 
